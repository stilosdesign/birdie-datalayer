...
namespace Birdie\Orm\DataLayer;

use PDO;
use PDOException;
use Exception;
use Birdie\Orm\Registry;
use Birdie\Orm\Registry\BiOrmRegistry;

/**
 * <b>BiOrmDataLayer</b>
 * 
 * BiOrmDataLayer is the class responsible for managing 
...
class BiOrmDataLayer {
   ...
   * the BiOrmDataLayer class which is responsible
  ...
  {
    $this->registry = BiOrmRegistry::getInstance();
