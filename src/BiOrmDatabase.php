...
namespace Birdie\Orm\Database;

use PDO;
/**
 * <b>BiOrmDatabase</b>
 * 
 * BiOrmDatabas is the class responsible for 
 ...
 * @since release 1.0.0
 */
class BiOrmDatabase extends PDO {
  /**
   ...
   * BiOrmDatabase class and is responsible for 
   * setting data in the connection instance
   * 
